...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatingADraftCampaignRequest :  IEquatable<UpdatingADraftCampaignRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatingADraftCampaignRequest" /> class.
        /// </summary>
        /// <param name="Name">The name of the campaign..</param>
        /// <param name="Subject">The subject line of the new campaign..</param>
        /// <param name="SenderEmail">The sender email of the campaign..</param>
        /// <param name="ReplyToEmail">The email address to which recipients replies will arrive. It must be one of your sender accounts. If not specified, the sender&#39;s email will be assumed..</param>
        /// <param name="IsAB">A flag that defines if a campaign is an AB campaign..</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdatingADraftCampaignRequest);
        }

        /// <summary>
        /// Returns true if UpdatingADraftCampaignRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdatingADraftCampaignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatingADraftCampaignRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
