...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatingASegmentRequest :  IEquatable<UpdatingASegmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatingASegmentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdatingASegmentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatingASegmentRequest" /> class.
        /// </summary>
        ...
        public UpdatingASegmentRequest(string Name = default(string), string MatchType = default(string))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for UpdatingASegmentRequest and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdatingASegmentRequest);
        }

        /// <summary>
        /// Returns true if UpdatingASegmentRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdatingASegmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatingASegmentRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
