...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    public partial class GetAllCampaignsResponse :  IEquatable<GetAllCampaignsResponse>, IValidatableObject
    {
        ...
        public GetAllCampaignsResponse(double? Code = default(double?), Context66 Context = default(Context66), string Error = default(string))
        {
            this.Code = Code;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetAllCampaignsResponse);
        }

        /// <summary>
        /// Returns true if GetAllCampaignsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GetAllCampaignsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAllCampaignsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
