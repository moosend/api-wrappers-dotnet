...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class B :  IEquatable<B>, IValidatableObject
    {
        /// <summary>
        ...
        public B(double? ABVersion = default(double?), string CampaignDeliveredOn = default(string), string CampaignID = default(string), bool? CampaignIsArchived = default(bool?), string CampaignName = default(string), string CampaignSubject = default(string), string From = default(string), List<MailingLists134> MailingLists = default(List<MailingLists134>), double? Sent = default(double?), string To = default(string), double? TotalBounces = default(double?), double? TotalComplaints = default(double?), double? TotalForwards = default(double?), double? TotalLinkClicks = default(double?), double? TotalOpens = default(double?), double? TotalUnsubscribes = default(double?), double? UniqueForwards = default(double?), double? UniqueLinkClicks = default(double?), double? UniqueOpens = default(double?))
        {
        ...
        public double? ABVersion { get; set; }
        ...
        public List<MailingLists134> MailingLists { get; set; }
        ...
        /// <summary>
        /// Returns true if B instances are equal
        /// </summary>
        /// <param name="other">Instance of B to be compared</param>
        /// <returns>Boolean</returns>
