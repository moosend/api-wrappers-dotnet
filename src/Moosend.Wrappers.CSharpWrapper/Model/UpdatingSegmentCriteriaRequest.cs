...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdatingSegmentCriteriaRequest :  IEquatable<UpdatingSegmentCriteriaRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatingSegmentCriteriaRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdatingSegmentCriteriaRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatingSegmentCriteriaRequest" /> class.
        /// </summary>
        ...
        public UpdatingSegmentCriteriaRequest(string Field = default(string), string Comparer = default(string), string Value = default(string), string DateFrom = default(string), string DateTo = default(string))
        {
            // to ensure "Field" is required (not null)
            if (Field == null)
            {
                throw new InvalidDataException("Field is a required property for UpdatingSegmentCriteriaRequest and cannot be null");
            }
            else
            {
                this.Field = Field;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdatingSegmentCriteriaRequest);
        }

        /// <summary>
        /// Returns true if UpdatingSegmentCriteriaRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdatingSegmentCriteriaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatingSegmentCriteriaRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
