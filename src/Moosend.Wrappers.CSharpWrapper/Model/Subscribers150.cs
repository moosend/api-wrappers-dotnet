...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Subscribers150 :  IEquatable<Subscribers150>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Subscribers150" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Subscribers150);
        }

        /// <summary>
        /// Returns true if Subscribers150 instances are equal
        /// </summary>
        /// <param name="other">Instance of Subscribers150 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Subscribers150 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
