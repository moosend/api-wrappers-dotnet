...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Context52 :  IEquatable<Context52>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Context52" /> class.
        /// </summary>
        ...
        public List<CustomField53> CustomFields { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Context52);
        }

        /// <summary>
        /// Returns true if Context52 instances are equal
        /// </summary>
        /// <param name="other">Instance of Context52 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Context52 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
