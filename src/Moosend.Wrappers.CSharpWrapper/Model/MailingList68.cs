...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MailingList68 :  IEquatable<MailingList68>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MailingList68" /> class.
        /// </summary>
        /// <param name="Campaign">.</param>
        /// <param name="MailingList">MailingList.</param>
        /// <param name="Segment">.</param>
        public MailingList68(string Campaign = default(string), MailingList69 MailingList = default(MailingList69), string Segment = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MailingList68);
        }

        /// <summary>
        /// Returns true if MailingList68 instances are equal
        /// </summary>
        /// <param name="other">Instance of MailingList68 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MailingList68 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
