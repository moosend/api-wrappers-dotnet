...
namespace Moosend.Wrappers.CSharpWrapper.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportOperation :  IEquatable<ImportOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public ImportOperation(string CompletedOn = default(string), string CreatedOn = default(string), string DataHash = default(string), string EmailNotify = default(string), double? ID = default(double?), string Mappings = default(string), string Message = default(string), string StartedOn = default(string), bool? Success = default(bool?), double? TotalDuplicate = default(double?), double? TotalInserted = default(double?), double? TotalInvalid = default(double?), double? TotalMembers = default(double?), double? TotalUnsubscribed = default(double?), double? TotalUpdated = default(double?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ImportOperation);
        }

        /// <summary>
        /// Returns true if ImportOperation instances are equal
        /// </summary>
        /// <param name="other">Instance of ImportOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportOperation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
