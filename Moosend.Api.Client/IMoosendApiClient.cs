...
namespace Moosend.Api.Client
{
    public interface IMoosendApiClient
    {
        ...
        /// <param name="pageSize"> The maximum number of results per page. If omitted, 10 mailing lists will be returned per page. </param>
        ...
        ///     Specifies whether to fetch statistics for the subscribers or not. If omitted, results
        ///     will be returned with statistics by default.
        /// </param>
        /// <param name="token"> Cancellation Token. </param>
        ...
        ///     Bounced : to fetch subscribers that have bounced on a previously sent campaign and are suspicious for not being
        ///     valid
        ///     Removed : to fetch removed subscribers pending deletion from our database
        ///     If omitted, all subscribers will be returned, no matter what their status is.
        /// </param>
        /// <param name="since">
        ...
        /// <param name="page"> The page number to display results for. If not specified, the first page will be returned. </param>
        /// <param name="pageSize">
        ///     The maximum number of results per page. This must be a positive integer up to 1000. If not specified, 500 results
        ///     per page will be returned.
        ///     If a value greater than 1000 is specified, it will be treated as 1000.
        /// </param>
        /// <param name="token"> Cancellation Token. </param>
        Task<SubscribersResponse> GetSubscribersAsync(Guid mailingListId, SubscribeType? status, DateTime? since = null, int page = 1, int pageSize = 500, CancellationToken token = default(CancellationToken));
        ...
        /// <param name="redirectAfterUnsubscribePage">
        ///     The URL of the page that users will be redirected after unsubscribing from
        ///     your mailing list.
        /// </param>
        /// <param name="token"> Cancellation Token. </param>
        /// <returns> The unique id for the mailing list created. </returns>
        ...
        ///     If ommitted, false will be assumed.
        /// </param>
        /// <param name="options">
        ///     If you want to create a custom field of type SingleSelectDropdown, you must set this parameter to specify the
        ...
        /// <summary>
        ///     Searches for a subscriber with the specified email address in the specified mailing list and returns detailed
        ...
        ///     If you try to add a subscriber with an invalid email address, this attempt will be ignored, as the process will
        ///     skip to the next subscriber automatically.
        /// </summary>
        /// <param name="mailingListId"> The ID of the mailing list to add subscribers to. </param>
        /// <param name="subscribers">
        ///     A list of subscribers to add to the mailing list. You may specify the email address, the
        ///     name and the custom fields for each subscriber.
        /// </param>
        /// <param name="token"> Cancellation Token. </param>
        /// <returns></returns>
        ...
        ///     This call will take into account the setting you have in "Supression list and unsubscribe settings" and will remove
        ///     the subscriber from all other mailing lists or not accordingly.
        /// </summary>
        /// <param name="mailingListId">
        ///     The ID of the mailing list to unsubscribe the subscriber from.
        ///     If also omitted, the email address of the subscriber will be unsubscribed from all mailing lists.
        /// </param>
        /// <param name="campaignId">
        ///     The ID of the campaign from which the subscriber unsubscribed. It can be omitted if no such information is
        ///     available.
        /// </param>
        ...
        /// <summary>
        ///     Removes a list of subscribers from the specified mailing list permanently (without putting them in the supression
        ///     list).
        ...
        /// <summary>
        ///     Searches for a subscriber with the specified unique id in the specified mailing list and returns detailed
        ...
        /// <summary>
        ///     Updates a subscriber in the specified mailing list. You can even update the subscribers email, if he has not
        ///     unsubscribed.
        /// </summary>
        /// <param name="mailingListId"> The ID of the mailing list to add the new member. </param>
        ...
        /// <param name="token"> Cancellation Token. </param>
        /// <returns></returns>
        Task<Subscriber> UpdateSubscriberAsync(Guid mailingListId, Guid subscriberId, SubscriberParams updatedMember, CancellationToken token = default(CancellationToken));
        ...
        /// <param name="token"> Cancellation Token. </param>
        /// <returns></returns>
        Task<SubscribersResponse> GetSegmentSubscribersAsync(Guid mailingListId, int segmentId, SubscribeType? status, int page = 1, int pageSize = 100, CancellationToken token = default(CancellationToken));
        ...
        /// <param name="token"> Cancellation Token. </param>
        /// <returns></returns>
        Task<Campaign> GetCampaignAsync(Guid campaignId, CancellationToken token = default(CancellationToken));
        ...
        /// </summary>
        /// <param name="campaignId"> The ID of the campaign to be cloned. </param>
        /// <param name="token"> Cancellation Token. </param>
        /// <returns></returns>
        Task<Campaign> CloneAsync(Guid campaignId, CancellationToken token = default(CancellationToken));

        /// <summary>
        ///     Creates a new campaign in your account. This method does not send the campaign, but rather creates it as a draft,
        ///     ready for sending or testing.
        ///     You can choose to send either a regular campaign or an AB split campaign.
        ...
        /// <param name="token"> Cancellation Token. </param>
        /// <returns></returns>
        Task<CampaignStatisticsSummary> GetCampaignSummaryAsync(Guid campaignId, CancellationToken token = default(CancellationToken));

        /// <summary>
        ///     Returns a detailed list of statistics for a given campaign based on activity such as emails sent, opened, bounced,
        ///     link clicked, etc.
        ///     Because the results from this call could be quite big, paging information is required as input.
        /// </summary>
        ...
        ///     Unsubscribed : to get information about who unsubscribed from the campaign by clicking on the unsubscribe link and
        ///     when.
        ...
        /// <param name="page"> The page number to display results for. If not specified, the first page will be returned. </param>
        /// <param name="pageSize">
        ///     The maximum number of results per page. This must be a positive integer up to 100. If not specified, 50 results per
        ///     page will be returned.
        ///     If a value greater than 100 is specified, it will be treated as 100.
        /// </param>
        /// <param name="from">
        ///     A date value that specifies since when to start returning results. If ommitted, results will be
        ///     returned from the moment the campaign was sent.
        /// </param>
        /// <param name="to">
        ///     A date value that specifies up to when to return results. If ommitted, results will be returned up to
        ///     date.
        /// </param>
        /// <param name="token"> Cancellation Token. </param>
        ...
        /// <summary>
        ///     Returns a list with your campaign links and how many clicks have been made by your recipients, either unique
        ///     or total. ///
        /// </summary>
        /// <param name="campaignId"> The ID of the requested campaign </param>
        /// <param name="token"> Cancellation Token. </param>
        ...
        /// <summary>
        ///     Removes a previously defined scheduled date and time from a campaign, so that it will be delivered immediately if
        ///     already queued or when sent.
        /// </summary>
        ...
        /// <summary>
        ///     Provides a basic summary of the results for a sent AB test campaign, separately for each version (A and B), such as
        ///     the number of recipients, opens, clicks, bounces, unsubscribes, forwards etc to date.
        /// </summary>
        ...
        ///     ///
        ///     <summary>
        ///         The timezone the specified date and time refers to. By default the timezone in your settings panel will be
        ///         used. If specified, one of the following values must be used:
        ///         <ul>
        ...
        /// </param>
        /// <param name="pageSize">
        ///     The maximum number of results per page. This must be a positive integer up to 100. If not specified, 100 results
        ///     per page will be returned.
        ///     If a value greater than 100 is specified, it will be treated as 100.
        /// </param>
        /// <param name="token"> Cancellation Token. </param>
        Task<SegmentsResponse> GetSegmentsForListAsync(Guid mailingListId, int page = 1, int pageSize = 100, CancellationToken token = default(CancellationToken));
        ...
        ///                 <pre>DateAdded</pre>
        ///             </strong>
        ///             : filters subscribers by the date they where added to the mailing list
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>RecipientName</pre>
        ///             </strong>
        ///             : filters subscribers by the recipient name
        ///         </li>
        ///         <li>
        ///             <strong>
        ...
        ///         <li>
        ///             <strong>
        ///                 <pre>CampaignsOpened</pre>
        ///             </strong>
        ///             : filters subscribers according to how many campaigns they have opened (within the past 60 days maximum)
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>LinksClicked</pre>
        ///             </strong>
        ///             : filters subscribers according to how many links they have clicked from previous campaigns sent to them
        ///             (within the past 60 days maximum)
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>CampaignName</pre>
        ///             </strong>
        ///             : filters subscribers according to which campaigns they have opened, based on their names
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>LinkURL</pre>
        ///             </strong>
        ///             : filters subscribers according to which links they have clicked, based on their urls
        ///         </li>
        ///         <li>
        ///             An ID of any custom field in the mailing list the segment belongs : filters the mailing list according to
        ///             the value of the specified custom field for each subscriber
        ///         </li>
        ///     </ul>
        /// </param>
        /// <param name="comparer">
        ///     An operator that defines the way to compare a criterion field with its value. This must be one of the following
        ///     values:
        ///     <ul>
        ///         <li>
        ///             <strong>
        ///                 <pre>Is</pre>
        ///             </strong>
        ///             : to find subscribers where the field is exactly <u>equal to</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsNot</pre>
        ///             </strong>
        ///             : to find subscribers where the field is <u>other than</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>Contains</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>contains</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>DoesNotContain</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>does not contain</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>StartsWith</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>starts with</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>DoesNotStartWith</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>does not start with</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>EndsWith</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>ends with</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>DoesNotEndWith</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>does not end with</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsGreaterThan</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>is greater than</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsGreaterThanOrEqualTo</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>is greater than or equal to</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsLessThan</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>is less than</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsLessThanOrEqualTo</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>is less than or equal to</u> the search term
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsBefore</pre>
        ///             </strong>
        ///             : to find subscribers where the specified date field <u>is before</u> the specified date value
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsAfter</pre>
        ///             </strong>
        ///             : to find subscribers where the specified date field <u>is after</u> the specified date value
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsEmpty</pre>
        ///             </strong>
        ///             : to find subscribers where the field <u>contains no value</u>
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsNotEmpty</pre>
        ///             </strong>
        ///             : to find subscribers <u>excluding</u> those where the field <u>contains no value</u>
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsTrue</pre>
        ///             </strong>
        ///             : to find subscribers where the condition defined by the field <u>is true</u>
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>IsFalse</pre>
        ///             </strong>
        ///             : to find subscribers where the condition defined by the field <u>is false</u>
        ///         </li>
        ///     </ul>
        ...
        ///                 <pre>CampaignsOpened</pre>
        ///             </strong>
        ///             : to search subscribers that opened campaigns that where sent since the specified date
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>LinksClicked</pre>
        ///             </strong>
        ///             : to search subscribers that clicked on links in campaigns that where sent since the specified date
        ///         </li>
        ///     </ul>
        /// </param>
        /// <param name="dateTo">
        ...
        ///                 <pre>CampaignsOpened</pre>
        ///             </strong>
        ///             : to search subscribers that opened campaigns that where sent up to the specified date
        ///         </li>
        ///         <li>
        ///             <strong>
        ///                 <pre>LinksClicked</pre>
        ///             </strong>
        ///             : to search subscribers that clicked on links in campaigns that where sent up to the specified date
        ///         </li>
        ///     </ul>
        /// </param>
        /// <param name="token"> Cancellation Token. </param>
